...
if(!$db) echo "Не вiдбулося зєднання з базою даних";
 ...
 $ath=mysql_query("SELECT DPS FROM security WHERE LOG='$lg';");
  if($ath)
...
for($i=1; $i<=$k; $i++){
$p.='<tr><td id="zal"><a href="select_nr_enter.php?nsp='.$nas[$i].'">'.$nas[$i].'</a></td></tr>';
}
$p.='</table>';
echo $p;
}
...
{
if($k==1) header("location: select_nr_enter.php?nsp=".$nas[1].""); 
