...
<tr><th colspan="9" style="font-size: 35px;"><b>Таксування</b></th></tr>
<tr><td colspan="9">
Серія замовлення
...
<tr>
<td colspan="9">
Технік &nbsp &nbsp &nbsp &nbsp <input type="text" name="tehnik" value="<?php echo $teh; ?>" readonly />
...
<td><?php echo $naim; ?></td>
<td><?php echo $odv; ?></td>
<td><input type="text" size="7" maxlength="8" name="<?php echo 'z'.$l; ?>" value="<?php echo $ch_def; ?>" <?php echo $fl_def; ?>/></td>
<td><input type="text" size="7" maxlength="8" name="<?php echo 'vum'.$l; ?>" value="<?php echo $vum;?>" readonly/></td>
<td><input type="text" size="7" maxlength="8" name="<?php echo 'vuk'.$l; ?>" value="<?php echo $vuk;?>" readonly/></td>
<td><input type="text" size="7" maxlength="8" name="<?php echo 'kontr'.$l; ?>" value="<?php echo $kontr;?>" readonly/>
<td><input type="text" size="4" maxlength="4" name="<?php echo 'skl'.$l; ?>" value="1" <?php echo $fl_skl; ?>/></td>
