...
for($i=1;$i<=6;$i++){$idr[$i]=0;} //обнуление массива для типов работников
...
<tr><th colspan="9" style="font-size: 35px;"><b>Корегування таксування</b></th></tr>
<tr><td colspan="9">
Серія замовлення<input type="text" size="6" maxlength="6" name="szam" value="<?php echo $sz; ?>" readonly />
<!--Юр. замовлення<input type="text" size="4" maxlength="4" name="szu" value="" readonly />-->
Номер замовлення<input type="text" size="6" maxlength="6" name="nzam" value="<?php echo $nz; ?>" readonly />
<input type="checkbox" name="zmi_yur" value="yes" <?php /* if($zmi_yur=='yes') echo 'checked'; */ ?> />Термінове юридичне замовлення зі змінами
</td>
</tr>
<tr><td colspan="9">
...
<tr>
<td colspan="9">
Технік &nbsp &nbsp &nbsp &nbsp <input type="text" id="vu" name="tehnik" value="<?php  echo $v_teh;?>" readonly/>
...
<td><?php echo $naim; ?></td>
<td><?php echo $odv; ?></td>
<td><input type="text" size="7" maxlength="8" name="<?php echo 'z'.$i; ?>" value="<?php echo $kol;?>" <?php echo $fl_def; ?>/></td>
<td><input type="text" size="7" maxlength="8" name="<?php echo 'vum'.$i; ?>" value="<?php echo $vum;?>" readonly/></td>
<td><input type="text" size="7" maxlength="8" name="<?php echo 'vuk'.$i; ?>" value="<?php echo $vuk;?>" readonly/></td>
<td><input type="text" size="7" maxlength="8" name="<?php echo 'kontr'.$i; ?>" value="<?php echo $kontr;?>" readonly/>
<td><input type="text" size="4" maxlength="4" name="<?php echo 'skl'.$i; ?>" value="<?php echo $skl;?>" <?php echo $fl_skl; ?>/></td>
