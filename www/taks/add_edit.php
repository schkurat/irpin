...
if(!$ath){echo "Таксировка не видалена з БД";}
...
if($vum==0) $s_vum=0;
if($brug==0) $s_kontr=0;
if($tp_zm==1){$vart=$s_teh+$s_arh+$s_pr+$s_vum+$s_kontr+$s_buro;}
if($tp_zm==2){$vart=round((($s_teh+$s_arh+$s_pr+$s_vum+$s_kontr+$s_buro)*2),2);}
