...
<ul class="topnav">
	<li><a href="#">Книга</a>
		<ul>
			<li><a href="samovol.php?filter=new_zap_info">Створити запис</a></li>
			<li><a href="samovol.php?filter=samovol_view&rejum=view&srt=NPP">Перегляд</a></li>
			<li><a href="samovol.php?filter=seach_info">Пошук</a></li>
		</ul>
	</li>
