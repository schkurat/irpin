...
$pdf->Text(15, 235 + $y, 'Відомості надані мною щодо об`єкту:');
$pdf->Text(15, 239 + $y, 'Документи:');
$pdf->Text(15, 244 + $y, $dtdog . 'р.                     ____________________________________ (' . $zamovnuk . ')');
$pdf->Text(15, 251 + $y, 'Прошу виконати замовлення в скорочений термін (3-и робочі дні)******    ___________________________________________');
$pdf->SetFont('dejavu', '', 7);
$pdf->Text(150, 254 + $y, 'підпис, П.І.Б.');
$pdf->SetFont('dejavu', '', 8);
$pdf->Text(15, 262 + $y, 'Замовлення-зобов`язання прийняв    ________________________  (' . $pruymalnuk . ')   ' . $dtdog . ' р.');
$pdf->Text(15, 272 + $y, 'Документи відповідно до замовлення отримав    ____________________  (                               )   "_____" ________________ 20 ___ року"');
