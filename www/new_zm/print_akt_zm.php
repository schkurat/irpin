...
$pdf->Text(15, 25, 'КП КОР "КИЇВСЬКЕ ОБЛАСНЕ БТІ"');
$pdf->Text(15, 32, '___________________________ О.Є. Кондратенко');
...
$pdf->SetFont('dejavu', '', 10);
$pdf->SetXY(14, 70);
$pdf->MultiCell(190, 4, 'Ми, що нижче підписалися, ' . $zamovnuk . ' з одного боку, та представник виконавця О.Є. Кондратенко з іншого боку, склали цей акт про те, що на підставі наведених документів:
