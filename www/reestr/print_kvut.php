...
$sql = "SELECT zamovlennya.*,dlya_oformlennya.document,nas_punktu.NSP, tup_nsp.TIP_NSP,
		...
		FROM zamovlennya,nas_punktu, vulutsi, tup_nsp, tup_vul, dlya_oformlennya,yur_kl 
		WHERE 
...
$mito=number_format($aut["ADM_ZBIR"],2,'.','');
if($t_zak==1){
...
$mitpr=$mitopr.' грн. '.$kp_mt.' коп. в т.ч. ПДВ – 20%';
...
$pruznachennya='';
if($mito==40.00) $pruznachennya='адміністративний збір за надання інформації з РРП';
if($mito==160.00) $pruznachennya='адміністративний збір за державну реєстрацію права власності';
if($mito==60.00) $pruznachennya='адміністративний збір за внесення змін до ДРРП';
if($mito>160.00) $pruznachennya='Плата за скорочення термінів надання послуг у сфері державної реєстрації речових прав на нерухоме майно та їх обтяжень, 40% адміністративного збору';
...
$replacements[12] = $pruznachennya;
$replacements[13] = $mito;
$replacements[14] = $mitpr;
$replacements[15] = $sbpdv;
$replacements[16] = $spdv;
