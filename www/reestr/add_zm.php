...
if($id_vr!="" and $pr!="" and $ns!="" and $vl!="" and $bd!="" and $sm!="" and $dg!=""){ 
 $ath1=mysql_query("INSERT INTO zamovlennya (SZ,NZ,NREE,TUP_ZAM,TERM,VUD_ROB,PR_OS,IDN,EDRPOU,IPN,SVID,PR,IM,PB,N_OBJ,PRIM,
	D_NAR,PASPORT,TEL,EMAIL,DOR,NS,VL,BUD,KVAR,SUM,ADM_ZBIR,D_PR,DATA_VUH,DATA_GOT)
	VALUES('$sz','$nz','$nree','$v_zm','$term','$id_vr','$priyom','$idn','$edrpou','$ipn','$svid','$pr','$im','$pb','$nobj','$prim',
	'$dn','$pasport','$tl','$email','$dover','$ns','$vl','$bd','$kva','$sm','$admzbir','$d_pr','$datav','$dg');");
	if(!$ath1){
