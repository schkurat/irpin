...
</form><form action="reestr.php?filter=reestr_view" name="myform" method="get">
<td align="center">
...
<form action="reestr.php" name="myform" method="get">
<table align="center" cellspacing=0 class="zmview">
<tr><th colspan="4" align="center">Пошук по номеру реєстраційному номеру</th></tr>
<tr>
<td>Номер замовлення
<input name="filter" type="hidden" value="reestr_view" />
<input name="fl" type="hidden" value="ree" /></td>
<td><input name="nree" type="text" size="8" />
</td>
</tr>
<tr><td align="center">
<input name="Ok" type="submit" value="Пошук" /></td>
...
<input name="filter" type="hidden" value="reestr_view" />
<input name="fl" type="hidden" value="kon" />
</td>
...
<td>Будинок: 
<input name="filter" type="hidden" value="reestr_view" />
<input name="fl" type="hidden" value="adres" />
</td>
