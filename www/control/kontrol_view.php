...
$sql = "SELECT zamovlennya.SZ,zamovlennya.NZ,zamovlennya.TUP_ZAM,zamovlennya.ZVON,
...
$vst1='id="zal"';
$vst2='<a href="kontrol.php?filter=zmina_vk&kl='.$aut["KEY"].'&vk='.$aut["VUK"].'&skl='.$aut["SKL"].'&zv='.$aut["ZVON"].'">';
$vst3=$zv.'</a>';
