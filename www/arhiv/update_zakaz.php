...
$ath1=mysql_query("UPDATE arhiv_zakaz SET VUD_ROB='$id_vr',EDRPOU='$edrpou',IPN='$ipn',SVID='$svid',SUBJ='$subj',
                ADR_SUBJ='$adrs_subj',PRILAD='$prilad',PR='$pr',IM='$im',PB='$pb',PRIM='$prim',SERT='$sert',"
                . "TEL='$tl',EMAIL='$email',DOR='$dover',RN='$rn',
		NS='$ns',VL='$vl',BUD='$bd',KVAR='$kv',SUM='$sm' WHERE arhiv_zakaz.KEY='$kl'");
	if(!$ath1){
