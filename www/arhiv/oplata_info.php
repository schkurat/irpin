...
<script type="text/javascript">
    $(document).ready(
        function () {
            ...
            $('#nzam, #address, #pib').keyup(net_fokusa);

            function net_fokusa(eventObj) {
                $.ajax({
                    type: "POST",
                    url: "seach_zm.php",
                    data: 'nzam=' + $("#nzam").val() + '&szam=' + $("#szam").val() + '&address=' + $("#address").val() + '&pib=' + $("#pib").val(),
                    dataType: "html",
...
<form action="arhiv.php" name="myform" method="get">
    ...
    <table align="center" class="zmview">
        ...
        <tr>
            <td>ПІБ (Назва)</td>
            <td style="width:100px"><input name="pib" id="pib" type="text"/>
            </td>
        </tr>
        <tr>
            <td>Вулиця</td>
            <td style="width:100px"><input name="address" id="address" type="text"/>
            </td>
        </tr>
        <tr>
            <td>Дата оплати</td>
