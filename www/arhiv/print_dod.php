...
від ' . $dt_serial . ' року Серія ' . $serial, 0, 'C', 0);
    $pdf->SetFont('dejavu', '', 10);
    $pdf->SetXY(19, 60);
    $pdf->MultiCell(188, 5, 'Ми, що нижче підписалися, КП КОР «ЗБЕРІГАЧ», в особі ' . $user . ' (Виконавець) та суб’єкт господарювання ' . $name_client . ', в особі ' . $boss . ' (Замовник) склали цей перелік про те, що Замовником передано, а Виконавцем прийнято на опрацювання наступні матеріали технічної інвентаризації:', 0, 'L', 0);
...
від ' . $dt_serial . ' року Серія ' . $serial, 0, 'C', 0);
    $pdf->SetFont('dejavu', '', 10);
    $pdf->SetXY(19, 60);
    $pdf->MultiCell(188, 5, 'Ми, що нижче підписалися, КП КОР «ЗБЕРІГАЧ», в особі ' . $user . ' (Виконавець) та суб’єкт господарювання ' . $name_client . ', в особі ' . $boss . ' (Замовник) склали цей перелік про те, що Замовником передано, а Виконавцем прийнято на зберігання наступні матеріали технічної інвентаризації:', 0, 'L', 0);
...
від ' . $dt_serial . ' року Серія ' . $serial, 0, 'C', 0);
    $pdf->SetFont('dejavu', '', 10);
    $pdf->SetXY(19, 60);
    $pdf->MultiCell(188, 5, 'Ми, що нижче підписалися, КП КОР «ЗБЕРІГАЧ», в особі ' . $user . ' (Виконавець) та суб’єкт господарювання ' . $name_client . ', в особі ' . $boss . ' (Замовник) склали цей перелік про те, що Виконавцем передано, а Замовником прийнято на доопрацювання наступні матеріали технічної інвентаризації:', 0, 'L', 0);
...
від ' . $dt_serial . ' року Серія ' . $serial, 0, 'C', 0);
    $pdf->SetFont('dejavu', '', 10);
    $pdf->SetXY(19, 60);
    $pdf->MultiCell(188, 5, 'Ми, що нижче підписалися, КП КОР «ЗБЕРІГАЧ», в особі ' . $user . ' (Виконавець) та суб’єкт господарювання ' . $name_client . ', в особі ' . $boss . ' (Замовник) склали цей перелік про те, що Замовником передано, а Виконавцем прийнято на опрацювання запити за наступними адресами:', 0, 'L', 0);
...
від ' . $dt_serial . ' року Серія ' . $serial, 0, 'C', 0);
    $pdf->SetFont('dejavu', '', 10);
    $pdf->SetXY(19, 60);
    $pdf->MultiCell(188, 5, 'Ми, що нижче підписалися, КП КОР «ЗБЕРІГАЧ», в особі ' . $user . ' (Виконавець) та суб’єкт господарювання ' . $name_client . ', в особі ' . $boss . ' (Замовник) склали цей перелік про те, що Виконавцем видано, а Замовником прийнято на наступні матеріали технічної інвентаризації:', 0, 'L', 0);
