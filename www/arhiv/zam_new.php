...
<td>ЄДРПОУ:</td>
<td colspan="3"><input type="text" id="edrpou" size="10" maxlength="10" name="edrpou" value=""/></td>
</tr>
<tr>
<td>ІПН:</td>
...
<td colspan="3"><input type="text" id="subj" size="59" maxlength="150" name="subj" value="" required/></td>
</tr>
<tr>
<td>Адреса суб'єкта: </td>
<td colspan="3"><input type="text" id="adrs_subj" size="59" maxlength="150" name="adrs_subj" value="" required/></td>
</tr>
<tr>
<td>Вимірювальний прилад: </td>
<td colspan="3"><input type="text" id="prilad" size="59" maxlength="150" name="prilad" value="" required/></td>
</tr>
<tr>
<td>Прізвище: </td>
...
<tr>
<td>Сертифікат: </td>
<td colspan="3"><input type="text" id="ser_sert" size="2" maxlength="2" name="ser_sert" value=""/>
...
<td>Дата прийому: </td>
<td>
    <input type="text" id="d_pr" size="10" maxlength="10" name="d_pr" value="<?php echo date("d.m.Y"); ?>" readonly />
    <input type="hidden" id="pr_osob" name="pr_osob" value="<?php echo $pr_prie.' '.p_buk($im_prie).'.'.p_buk($pb_prie).'.'; ?>" readonly/></td>
</td>
</tr>
<tr>
