...
<form action="add_zm.php" name="myform" method="post" enctype="multipart/form-data">
    <table align="" class="zmview">
        ...
        <tr>
            ...
            <td colspan="3"><input type="text" id="adrs_subj" size="59" maxlength="150" name="adrs_subj" value=""
                                   required/></td>
        </tr>
        <tr>
            <td>Вимірювальний прилад:</td>
            <td colspan="3"><input type="text" id="prilad" size="59" maxlength="150" name="prilad" value="" required/>
            </td>
        </tr>
        <tr>
            <td>Прізвище:</td>
