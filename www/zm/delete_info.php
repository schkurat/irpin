...
<a href="zamovlennya.php?filter=zm_view"><input name="cancel" type="button" value="OK"></a></td>
</tr>';
}
else{
$p.='<tr bgcolor="#FFFAF0">
...
<a href="zamovlennya.php?filter=zm_view"><input name="cancel" type="button" value="Відміна"></a>
</td>
</tr>';
}
$p.='</table>';
