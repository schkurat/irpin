...
$pdf->Text(60,10,'Відомість передачі замовлень в архів');
...
$pdf->SetXY(50, 20);
$pdf->MultiCell(60,10,'Вид робіт',1,'C',0);
$pdf->SetXY(110, 20);
$pdf->MultiCell(60,10,'ПІБ',1,'C',0);
$pdf->SetXY(170, 20);
...
//$pdf->SetXY(170, 25); 
$pdf->Text(12,35+$it,(string)$nn);
$pdf->Text(22,35+$it,$sz.'*'.$nz); 
$pdf->Text(53,35+$it,$v_rob);  
$pdf->Text(112,35+$it,$pr.' '.p_buk($im).'.'.p_buk($pb).'.');
$pdf->Text(172,35+$it,$d_got);  
$pdf->Text(22,40+$it,$rn.' '.$tns.$ns.' '.$tvl.$vl.' '.$budd.$kvarr);
$pdf->Line(10,42+$it,200,42+$it);  
$it=$it+12;
$nn=$nn+1;
 } 
