...
$(document).ready(function(){
	...
	function s_vart(eventObj){
		...
		success: function(html){
			...
			if(rep[1]==1) {$("#plos").attr("disabled","disabled");
				$("#plos").val("");
				$("#sm").val(rep[0]);
				$("#sumt").val(0);}
			if(rep[1]==2) {$("#plos").attr("disabled","");
				$("#idpr").val(rep[2]);
				$("#sumt").val(rep[0]);
				$("#sm").val(rep[0]);}
		},	
...
$sql = "SELECT zamovlennya.*,dlya_oformlennya.document,nas_punktu.NSP, tup_nsp.TIP_NSP,vulutsi.VUL,tup_vul.TIP_VUL
...
<td><input id="r1" type="radio" name="vud_zam" value="1" '.$fiz.'/><label for="r1">Фізичне</label></td>
<td><input id="r2" type="radio" name="vud_zam" value="2" '.$yur.'/><label for="r2">Юридичне</label></td>
</tr>
<tr>
<td>ІДН замовника: </td>
<td colspan="3"><input type="text" id="idn" size="12" maxlength="12" name="kod" value="'.$aut["IDN"].'"'.$filter["kod_os"].'/></td>
...
<td colspan="3">
<!--<input type="text" required id="dl_ofor" size="50" maxlength="50" name="vud_rob" value="'.$aut["document"].'"'.$filter["tup_zam"].'/>-->
'.$vst_vr.'
</td>
</tr>
<tr>
...
<tr>
<td>Імя: </td>
<td colspan="3"><input type="text" id="im" size="20" maxlength="20" name="imya" value="'.$aut["IM"].'"'.$filter["zvat"].'/></td>
</tr>
<tr>
<td>Побатькові: </td>
<td colspan="3"><input type="text" id="pb" size="20" maxlength="20" name="pobat" value="'.$aut["PB"].'"'.$filter["otche"].'/></td>
</tr>
<tr>
<td>Примітка: </td>
<td colspan="3"><input type="text" id="prim" size="59" name="prim" value="'.$aut["PRIM"].'"'.$filter["prim"].'/></td>
</tr>
<tr>
<td>Дата народження: </td>
<td colspan="3"><input type="text" id="dn" size="10" maxlength="10" name="dnar" value="'.german_date($aut["D_NAR"]).'"'.$filter["nard"].'/></td>
</tr>
<tr>
<td>Паспорт: </td>
<td colspan="3"><input type="text" id="pasport" size="30" maxlength="30" name="pasport" value="'.$aut["PASPORT"].'"'.$filter["pasp"].'/></td>
</tr>
<tr>
<td>Телефон: </td>
...
<td colspan="3"><input type="text" size="50" maxlength="50" name="adrprj" value="'.$aut["PROPISKA"].'"'.$filter["prop"].'/></td>
</tr>-->
<tr>
<td>Сума: </td>
<td colspan="3"><input type="text" id="sm" size="20" maxlength="20" name="sum" value="'.$aut["SUM"].'"'.$filter["vartist"].'/></td>
</tr>
<!--<tr>
<td>Дата виходу: </td>
<td colspan="3">
<input type="text" id="date" size="10" maxlength="10" name="datav" value="'.german_date($aut["DATA_VUH"]).'"'.$filter["vuhidd"].'/></td>
</tr>-->
<tr>
<td>Дата готовності: </td>
<td colspan="3">
<input type="text" id="date1" size="10" maxlength="10" name="datag" value="'.german_date($aut["DATA_GOT"]).'"'.$filter["gotd"].'/></td>
</tr>
<tr>
