...
if ($pr != "") {
    ...
    $p[1] = '<td align="center"><A href="control2/index.php">
    ...
    $p[3] = '<td align="center"><A href="taks/taks.php">
    ...
    $p[7] = '<td align="center"><A href="e_arhiv/earhiv.php">
    ...
    $p[9] = '<td align="center"><A href="arhiv/arhiv.php">
    <img src="images/arh.png" style="width:100px;height:100px" title="Архів" alt="Архів" border="0">
    </A></td>';
    $p[10] = '<td align="center"><A href="kans/kanselyariya.php">
