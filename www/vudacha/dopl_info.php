...
<tr>
<td>ІДН замовника: </td>
<td colspan="3"><input type="text" size="12" maxlength="12" name="kod" value="<?php echo $idn; ?>"/></td>
</tr>
<tr>
<td>Прізвище: </td>
<td colspan="3"><input type="text" size="20" maxlength="20" name="priz" value="<?php echo $pr; ?>"/></td>
</tr>
<tr>
<td>Ім'я: </td>
<td colspan="3"><input type="text" size="20" maxlength="20" name="imya" value="<?php echo $im; ?>"/></td>
</tr>
<tr>
<td>Побатькові: </td>
<td colspan="3"><input type="text" size="20" maxlength="20" name="pobat" value="<?php echo $pb; ?>"/></td>
</tr>
<tr>
<td>Дата народження: </td>
<td colspan="3"><input type="text" size="10" maxlength="10" name="dnar" value="<?php echo $d_nar; ?>"/></td>
</tr>
<tr>
<td>Телефон: </td>
...
<tr>
<td>Доручення: </td>
<td colspan="3"><input type="text" size="30" maxlength="40" name="doruch" value="<?php echo $doruch; ?>"/></td>
</tr>
<tr>
<td>Район: </td>
<td colspan="3">
...
<td colspan="3">
<input type="text" size="30" maxlength="30" name="nasp" value="<?php echo $tns.' '.$ns; ?>"/>
</td>
</tr>
<tr>
<td>Вулиця: </td>
...
<form action="vudacha.php?filter=vudacha_view" name="reset_form" method="post">
