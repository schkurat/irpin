...
<tr bgcolor="#F4A460" align="center"><td>Раніше створені по поверхові плани</td></tr>';

$k=0;
$sql="SELECT POET,POET_BAK FROM tehnik WHERE tehnik.DL='1' AND tehnik.NR='$nr' AND tehnik.NS='$ns' 
...
$p.='<tr bgcolor="#FFFAF0"><td id="zal" align="center"><a href="download_zm.php?hr='.$aut["POET"].'">'.$rez_obr.'</a></td></tr>';
$p.='<tr bgcolor="#FFFAF0"><td id="zal" align="center"><a href="download_zm.php?hr='.$aut["POET_BAK"].'">'.$rez_obr.' - допоміжний файл</a></td></tr>';
$k=1;}
}
mysql_free_result($atu);

if($k==0) $p.='<tr bgcolor="#FFFAF0"><td align="center">За даною адресою по поверхові плани раніше не створювались!</td></tr>';

$p.='<tr bgcolor="#F4A460"><th>Вкажіть файли кресленнь</th></tr>';
$p.='<form action="add_poet.php" method="post" enctype="multipart/form-data">
