...
<ul class="topnav">
  ...
  <li><a href="#">Справи</a>
	...
	<li><a href="#">Пошук</a>
		<ul>
			<li><a href="index.php?filter=seach_kontrol&krit=zm">Замовлення к</a></li>
			<li><a href="index.php?filter=seach_kontrol&krit=adr">Адреса к</a></li>
			<li><a href="index.php?filter=seach_kontrol&krit=kont">Власник (Назва) к</a></li>
      <li><a href="index.php?filter=seach_pidpus&krit=zm">Замовлення п</a></li>
			<li><a href="index.php?filter=seach_pidpus&krit=vuk">Виконавець п</a></li>
			<li><a href="index.php?filter=seach_pidpus&krit=adr">Адреса п</a></li>
		</ul>
	</li>
	<li><a href="#">Друк</a>
		<ul>
