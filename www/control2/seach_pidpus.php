        ...
        <table align="center" class="zmview">
            ...
            <tr>
                <td>Серія замовлення
                    ...
                    <input name="filter" type="hidden" value="pidpus_view"/>
                </td>
                <td style="width:100px"><input name="szam" type="text" size="6" maxlength="6"
                                               value="<?php echo date("dmy"); ?>"/></td>
            </tr>
            <tr>
...
if ($krit == "vuk") {
    ...
    <form action="index.php" name="myform" method="get">
        <table align="center" class="zmview">
            <tr>
                <th colspan="4" align="center">Пошук по виконавцю</th>
            </tr>
            <tr>
                <td>Виконавець
...
if ($krit == "adr") {
    ...
    <form action="index.php" name="myform" method="get">
        <table align="center" class="zmview">
            <tr>
                <th colspan="4" align="center" bgcolor="#999999">Пошук по за адресою</th>
                <input name="filter" type="hidden" value="pidpus_view"/>
            </tr>
            <tr>
